...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Generate a list of blog titles for the topic: "${input}" in the category "${selectedCategory}".`;
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>
                Enter a topic and click "Generate Title" to create your article.
              </p>
            </div>
          </div>
        ) : (
